...
export function NotificationBell() {
  ...
  return (
    <div className="relative" style={{ zIndex: 3 }}>
      ...
      {open ? createPortal(
        <div className="fixed left-2 right-2 top-[4.5rem] z-[1000] overflow-hidden rounded-2xl border border-border bg-card shadow-2xl md:left-auto md:right-4 md:top-16 md:w-[min(24rem,calc(100vw-2rem))]">
