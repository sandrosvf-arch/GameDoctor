...
export function NotificationBell() {
  ...
  return (
    <div className="relative" style={{ zIndex: 3 }}>
      ...
      {open ? createPortal(
        <div className="fixed bottom-auto left-2 right-2 top-[4.5rem] z-[1000] box-border flex max-h-[70vh] w-auto max-w-none min-w-0 flex-col overflow-x-hidden overflow-y-hidden rounded-2xl border border-border bg-card shadow-2xl md:left-auto md:right-4 md:top-16 md:max-h-none md:w-[min(24rem,calc(100vw-2rem))]" style={{ maxWidth: "calc(100vw - 1rem)" }}>
