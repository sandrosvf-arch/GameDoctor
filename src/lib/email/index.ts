...
export async function sendNotificationEmail(input: {
  ...
  const html = isLesson
    ? `<div style="margin:0;background:#070b12;padding:24px 12px;font-family:Arial,Helvetica,sans-serif;color:#f8fafc"><div style="max-width:620px;margin:0 auto;overflow:hidden;border:1px solid #26384a;border-radius:22px;background:#0d141e;box-shadow:0 18px 60px rgba(0,0,0,.35)"><div style="height:7px;background:linear-gradient(90deg,#00cfff 0%,#00cfff 58%,#fb7185 100%)"></div><div style="padding:30px 28px 32px"><div style="font-size:19px;font-weight:800;letter-spacing:-.04em"><span style="color:#f8fafc">Game</span><span style="color:#00cfff">Doctor</span><span style="display:inline-block;width:6px;height:6px;margin-left:5px;border-radius:50%;background:#fb7185;vertical-align:middle"></span></div><p style="margin:30px 0 12px;color:#00cfff;font-size:11px;font-weight:800;letter-spacing:.16em;text-transform:uppercase">Conteúdo novo no ar</p>${testBadge}<h1 style="margin:0;color:#f8fafc;font-size:34px;line-height:1.12;letter-spacing:-.04em">Nova aula disponível</h1><p style="margin:10px 0 0;color:#8eeaff;font-size:18px;font-weight:700;line-height:1.35">${safeLessonTitle}</p><p style="margin:22px 0 0;color:#d5dee9;font-size:16px;line-height:1.75">Olá, ${safeFirstName}.</p><p style="margin:10px 0 0;color:#a9b8c9;font-size:15px;line-height:1.7">Uma nova aula acaba de entrar na GameDoctor. Aproveite enquanto o conteúdo está fresco e avance mais um passo na sua jornada profissional.</p><div style="margin:24px 0;padding:18px 18px;border-left:3px solid #fb7185;border-radius:0 12px 12px 0;background:#141e2b"><p style="margin:0;color:#e6edf5;font-size:15px;line-height:1.7">${safeBody}</p></div>${safeHref ? `<a href="${safeHref}" style="display:inline-block;background:#00cfff;color:#061018;text-decoration:none;font-size:15px;font-weight:800;padding:15px 22px;border-radius:11px;box-shadow:0 8px 24px rgba(0,207,255,.2)">Assistir aula agora &rarr;</a>` : ""}<p style="margin:26px 0 0;color:#718198;font-size:12px;line-height:1.6">Entre na plataforma, assista à aula e mantenha seu ritmo de evolução. Nos vemos lá.</p></div><div style="border-top:1px solid #1c2a3a;padding:18px 28px;color:#62738a;font-size:11px;line-height:1.6">GameDoctor · Conhecimento técnico para quem leva manutenção a sério.<br />Você recebeu este aviso porque faz parte da comunidade GameDoctor.</div></div></div>`
